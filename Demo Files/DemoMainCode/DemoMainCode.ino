/*
 ...
 ~~              G00470372                    ~~
 ~~    Year 2, Semester 1 & 2 IoT Project     ~~
*/
// ~~ LIBRARIES ~~
#include <Wire.h>
#include "rgb_lcd.h"
...
const int heatUL = 24, heatLL = 18, lightL = 80; 
//Thresholds for temperature and light flags, used to update warning LEDs and text
...
// ~~ FUNCTIONS ~~
// Function that returns a string containing heat reading
String getTemp() {
  ...
  // If loop for setting warning indicator
...
// Function that returns a string that contains a precentage value of how bright the area is
String getLight(){
